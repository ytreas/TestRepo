...
class JournalLedgerReportWizard(models.TransientModel):
    ...
    date_to_bs = fields.Char(string="Date To BS",store=True)
    ...
    def _prepare_report_journal_ledger(self):
        ...
        return {
            ...
            "date_from_bs": self.get_date_bs(self.date_from),
            "date_to": self.date_to,
            "date_to_bs": self.get_date_bs(self.date_to),
    ...
    @api.model
    def get_partner_details_np(self,partner_id):
        res_partner=self.env['res.partner'].sudo().browse(partner_id)
        if res_partner.exists():
            return res_partner.name_np or res_partner.name

...
class HrSalaryRule(models.Model):
    ...
    name = fields.Char( translate=True, string="Salary Rule Name",
    ...
    other_allowance = fields.Boolean(string='Other Allowance')
    ...
    def _compute_display_name(self):
        for rec in self:
            rec.display_name = f"{rec.name or ''} / {rec.type or ''}"

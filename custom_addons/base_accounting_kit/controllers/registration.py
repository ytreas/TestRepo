...
#                 update_vals['ward_no'] = kw.get('ward_no')
    ...
    @http.route("/trading/api/reset_password/request_otp", type="http", auth="public", cors="*", methods=["POST"], csrf=False)
        ...
        try:
            ...
            mail_values = {
                ...
                'body_html': f"""
                    ...
                    <p>Thank you,<br/>LekhaPlus Team</p>
                """,
                'email_from': request.env.user.company_id.email or 'noreply@lekhaplus.com',
                'email_to': email,
            }
    ...
    @http.route("/trading/api/reset_password/validate_otp", type="http", auth="public", cors="*", methods=["POST"], csrf=False)
    ...
    @http.route("/trading/api/reset_password/change_password", type="http", auth="public", cors="*", methods=["POST"], csrf=False)
